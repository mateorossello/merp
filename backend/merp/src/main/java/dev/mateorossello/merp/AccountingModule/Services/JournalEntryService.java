...
import dev.mateorossello.merp.AccountingModule.Mappers.JournalEntryMapper;
...
import dev.mateorossello.merp.AccountingModule.Repositories.JournalEntryRepository;
...
public class JournalEntryService {
    ...
    public JournalEntry getJournalEntryByLatestDate() {
        return journalEntryRepository.findFirstByOrderByEntryDateDesc().orElse(null);
    }
